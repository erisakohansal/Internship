...
#SBATCH -q default
#SBATCH --time 3:00:00
#SBATCH --job-name=mopd
#SBATCH --output=slurm/logs/mopd_%j.out
#SBATCH --error=slurm/logs/mopd_%j.err
...
CHECKPOINT_PATH="/project/home/p201382/erisa/MOPD/checkpoints"
TRAIN_FILE="$PWD/data/mcqa-train.parquet"
TEST_FILE="$PWD/data/mcqa-test.parquet"
MAX_PROMPT_LEN=5000
