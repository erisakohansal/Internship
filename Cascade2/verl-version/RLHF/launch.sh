...
#SBATCH --output=slurm/logs/rlhf_%j.out
#SBATCH --error=slurm/logs/rlhf_%j.err
...
PWD="/project/scratch/p201382/erisa/Internship/Cascade2/verl-version/RLHF"
cd $PWD
...
CHECKPOINT_PATH="/project/home/p201382/erisa/RLHF/checkpoints"
MAX_PROMPT_LEN=6000
MAX_RESPONSE_LEN=4000                                             
MAX_MODEL_LEN=$(( MAX_PROMPT_LEN + MAX_RESPONSE_LEN ))  
MODEL_PATH=${MODEL_PATH:-Qwen/Qwen2.5-1.5B-Instruct} 
REWARD_MODEL_PATH=${REWARD_MODEL_PATH:-Skywork/Skywork-Reward-V2-Llama-3.1-8B} # or Skywork/Skywork-Reward-V2-Qwen3-8B
...
python3 -m verl.trainer.main_ppo \
  ...
  actor_rollout_red.actor.kl_loss_type=low_var_kl \
  ...
  trainer.project_name=rlhf \
  trainer.experiment_name=rlhf \
