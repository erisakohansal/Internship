...
#SBATCH --job-name=if_rl_fraction
#SBATCH --output=slurm/logs/if_rl_fraction_%j.out
#SBATCH --error=slurm/logs/if_rl_fraction_%j.err
...
CHECKPOINT_PATH="/project/home/p201382/erisa/IF_RL_Fraction/new/checkpoints"
...
python3 -m verl.trainer.main_ppo \
  ...
  trainer.experiment_name=if_rl_fraction \
